  ...
  <div className="w-fit">
    <div className="relative flex size-full items-center justify-start">
      <motion.span
        ...
        className="absolute top-0 left-2 size-3.5 rounded-full bg-current"
      ></motion.span>
      <motion.span
        initial={{ x: 0 }}
        animate={{ x: 24 }}
      ...
      <motion.span
        ...
        animate={{ x: 24 }}
        transition={{ duration: 0.7, repeat: Infinity }}
        className="absolute top-0 left-8 size-3.5 rounded-full bg-current"
      ></motion.span>
      <motion.span
        initial={{ scale: 1 }}
        animate={{ scale: 0 }}
        transition={{ duration: 0.7, repeat: Infinity }}
        className="absolute top-0 left-14 size-3.5 rounded-full bg-current"
      ></motion.span>
    </div>
  </div>
);
